...
import { View,  StyleSheet, SafeAreaView, TextInput, Platform, StatusBar, ScrollView, Text, Image, Dimensions, Animated } from 'react-native';
          ...
          >
            <View style={{flex: 1, backgroundColor: 'white', paddingTop: 20}}>
              <Text style={{fontSize: 24, fontWeight: '700', paddingHorizontal: 20}}>
                What can we help you find, Rahmat?
              </Text>
